...
public class Expense {
    ...
    public Expense(int groupId, User payer, Money amount, List<User> participants, LocalDate date, String description) throws IllegalArgumentException{
        ...
        if(participants == null || participants.isEmpty()) throw new IllegalArgumentException("Participants are required.");
        ...
        unique.add(payer);
        this.participants = Collections.unmodifiableList(new ArrayList<>(unique));
